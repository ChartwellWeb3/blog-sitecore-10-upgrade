...
namespace Sitecore.Feature.XBlog.Areas.XBlog.General
{
    public sealed class XBSettings
    {
        ...
        public static string XBSearchPublishDate
        {
            get
            {
                return Settings.GetSetting("XBSearchPublishDate", "Publish Date");
            }
        }

        public static string XBSearchFeaturedBlog
        {
            get
            {
                return Settings.GetSetting("XBSearchFeaturedBlog", "Publish Date");
            }
        }
