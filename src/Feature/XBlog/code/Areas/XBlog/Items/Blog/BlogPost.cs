...
namespace Sitecore.Feature.XBlog.Areas.XBlog.Items.Blog
{
    ...
    public class BlogPost : SitecoreItem
    {
        ...
        public const string BlogPostFeaturedFieldId = "{41E7318E-66E6-4EFD-BE28-39DAC4414A5A}";
        public const string BlogImageFieldId = "{E9F98F13-EB82-4FF6-B86E-3719F7269DAB}";
        ...
        public const string BlogPostFeaturedField = "isFeaturedBlog";
        public const string BlogImageField = "BlogPostImage";
        ...
        [SitecoreItemField(BlogPostFeaturedFieldId)]
        public virtual CheckboxField FeaturedPost { get; set; }


        [SitecoreItemField(BlogImageFieldId)]
        public virtual ImageField BlogImage { get; set; }
        public string BlogImageUrls { get; set; }
    }
}
